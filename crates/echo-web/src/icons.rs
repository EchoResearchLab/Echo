...
fn path_for(name: &str) -> &'static str {
    match name {
        ...
        "arrow-right" => "M4.5 10h11M11 5.5l4.5 4.5-4.5 4.5",
        "stop" => "M7 7h6v6H7z",
        "copy" => {
        ...
        "star" => "M10 4.2l1.9 3.9 4.3.6-3.1 3 .75 4.3L10 13.9l-3.85 2.1.75-4.3-3.1-3 4.3-.6z",
        "eye" => {
        ...
        "lock" => {
            "M6.2 9V7.6a3.8 3.8 0 0 1 7.6 0V9M5.6 9h8.8a.9.9 0 0 1 .9.9v4.7a.9.9 0 0 1-.9.9H5.6a.9.9 0 0 1-.9-.9V9.9a.9.9 0 0 1 .9-.9Z"
        }
        "bell" => {
        ...
        "sparkle" => {
            "M10 3.5l1.35 3.6L15 8.4l-3.65 1.3L10 13.3 8.65 9.7 5 8.4l3.65-1.3zM15 13l.6 1.5 1.5.6-1.5.6-.6 1.5-.6-1.5-1.5-.6 1.5-.6z"
        }
        ...
        >
            <defs>
                <linearGradient id="echo-ring" x1="8" y1="5" x2="44" y2="48" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#0f2e2a"/>
                    <stop offset=".5" stop-color="#2f7a6f"/>
                    <stop offset="1" stop-color="#8fb5ae"/>
                </linearGradient>
            </defs>
            <path
            ...
            <path
                ...
                stroke-linecap="round"
            />
            <circle cx="16.4" cy="27.7" r="2.1" fill="#4f9a8e"/>
        </svg>
    }
}
